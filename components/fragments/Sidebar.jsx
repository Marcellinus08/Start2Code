        ...
        <aside className="w-64 bg-white shadow-lg p-6 h-screen fixed top-0 left-0 flex flex-col justify-between">
            <div>
                ...
                <nav className="space-y-2">
                    <a class="flex items-center space-x-2 px-4 py-3 hover:bg-blue-100 hover:text-blue-600 rounded-lg transition duration-150 ease-in-out bg-blue-500 text-white shadow-md" href="#">
